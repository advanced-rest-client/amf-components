...
describe('ApiSchemaDocumentElement', () => {
  ...
  describe('Schema rendering', () => {
    ...
    describe('And type (OAS)', () => {
      ...
      let model;
      before(async () => {
        model = await loader.getGraph('Petstore-v2');
        store.amf = model;
      });
  ...
  describe('Read only properties', () => {
    ...
    let model;
    before(async () => {
      model = await loader.getGraph('read-only-properties');
      store.amf = model;
    });
  ...
  describe('APIC-631', () => {
    ...
    let model;
    before(async () => {
      model = await loader.getGraph('APIC-631');
      store.amf = model;
    });
  ...
  describe('AAP-1698', () => {
    ...
    let model;
    before(async () => {
      model = await loader.getGraph('aap-1698');
      store.amf = model;
    });
  ...
  describe('APIC-332', () => {
    ...
    let model;
    before(async () => {
      model = await loader.getGraph('APIC-332');
      store.amf = model;
    });
